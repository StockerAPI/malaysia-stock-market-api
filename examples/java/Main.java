...
public class Main {
    ...
    private static final String MARKET = "MY";
    private static final String EXCHANGE = "MYX";
    private static final String SYMBOL = "MYX:000040";
                ...
                .buildAsync(URI.create(WS_URL), new WebSocket.Listener() {
                    ...
                    public void onOpen(WebSocket webSocket) {
                        String subscribeJson = "{\"action\":\"subscribe\",\"market\":\"" + MARKET
                                + "\",\"exchange\":\"" + EXCHANGE
                                + "\",\"symbols\":[\"MYX:000040\",\"MYX:005930\"],\"replay\":\"last\"}";
